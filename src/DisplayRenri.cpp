...
void DisplayRenri::showControls(int row, int col){
...
void DisplayRenri::showDigit(int digitIndex, int row, int col){
  for(int i = 0; i < 5; i++){
...
void DisplayRenri::setMemory(bool enable){ 
    this->memory = enable;
  }
  
void DisplayRenri::setNegative(bool enable){ 
    this->negative =  enable;
  }
  
void DisplayRenri::setError(bool enable){ 
    this->error = enable;
  }
